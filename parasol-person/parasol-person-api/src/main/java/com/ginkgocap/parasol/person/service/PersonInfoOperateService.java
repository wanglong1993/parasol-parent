...
public interface PersonInfoOperateService {
	/**
	 * 新增用户信息，分模块保存
	 ...
	 * @throws Exception
	 */
	public Map<String,Object> getInfo(Long personId,Integer[] models) throws Exception;
	/**
	 * 修改用户的信息，分模块修改。
	 * @param param
	 * @return
	 ...
	 * @throws Exception
	 */
	public Boolean deleteInfo(Long personId,List<Integer> modelType) throws Exception;
}
