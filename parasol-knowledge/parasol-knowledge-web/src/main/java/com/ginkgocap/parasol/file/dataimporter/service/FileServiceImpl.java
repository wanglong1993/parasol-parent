...
import com.ginkgocap.parasol.file.dataimporter.dao.FileIndexDao;
...
public class FileServiceImpl implements FileService {
	...
	public List<Index> getAllFileIndexes(int start, int limit) {

		return fileIndexDao.getAllFileIndexes(start, limit);
	}
