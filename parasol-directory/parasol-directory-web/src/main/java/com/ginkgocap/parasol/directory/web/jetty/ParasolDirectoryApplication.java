...
@Configuration
@ComponentScan(basePackages="com.ginkgocap.parasol.directory")
@ImportResource("classpath:applicationContext.xml")
public class ParasolDirectoryApplication{

	public static void main(String[] args) throws Exception {
		
		//SpringApplication.run(SampleJettyApplication.class, args);
		SpringApplication.run(ParasolDirectoryApplication.class, args);
