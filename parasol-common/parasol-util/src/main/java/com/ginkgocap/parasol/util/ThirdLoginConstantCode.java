...
public enum ThirdLoginConstantCode {
	...
	LOGIN_QQ_ERROR(103,"redirect:/login","用户QQ账号登陆异常，请重新登陆"),
	QQ_USER_INFO(104,"QQ_USER_INFO","QQ用户信息"),
		
	LOGIN_WEIBO(200,"LOGIN_WEIBO","用户通过微博方式登陆"),
	LOGIN_WEIBO_BIND(201,"","用户微博账号已经绑定，跳转首页"),
	LOGIN_WEIBO_NO_BIND(202,"","用户微博账号未绑定,跳转完善资料页"),
	LOGIN_WEIBO_ERROR(203,"redirect:/login","用户微博账号登陆异常，请重新登陆"),
	LOGIN_WEIBO_USER(204,"LOGIN_WEIBO_USER","微博用户信息"),
	
	LOGIN_UID(300,"LOGIN_UID","第三方登陆uid"),
	ACCESS_TOKEN(301,"ACCESS_TOKEN","第三方登陆accessToken"),
