...
import org.parasol.column.utils.CommonUtil;
...
import org.parasol.column.utils.Constant;
import org.parasol.column.utils.RedisKeyUtils;
...
public class AppFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		for (String excludedUrl : excludedUrlArray) {
			if (url.contains(org.parasol.column.utils.StringUtils.replaceSpecial(excludedUrl))) {
				loginFlag = false;
				break;
			}
		}		
