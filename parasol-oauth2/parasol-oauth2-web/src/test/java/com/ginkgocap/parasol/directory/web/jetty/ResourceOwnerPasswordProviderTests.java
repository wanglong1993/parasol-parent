...
public class ResourceOwnerPasswordProviderTests {
	...
	public void testUnauthenticated() throws Exception {
		...
		assertEquals(HttpStatus.UNAUTHORIZED, serverRunning.getStatusCode("/directory/type/getTypeList?appKey=1"));
	}

	@Test
	public void testUnauthenticatedErrorMessage() throws Exception {
		HttpHeaders headers = new HttpHeaders();
		ResponseEntity<Void> response = serverRunning.getForResponse("/directory/type/getTypeList?appKey=1", headers);
	...
	public void testTokenObtainedWithHeaderAuthentication() throws Exception {
		assertEquals(HttpStatus.OK, serverRunning.getStatusCode("/directory/type/getTypeList?appKey=1"));
	...
	public void testUnsupportedMediaType() throws Exception {
		...
		// story.
		assertEquals(HttpStatus.OK, serverRunning.getStatusCode("/directory/type/getTypeList?appKey=1", headers));
	}
