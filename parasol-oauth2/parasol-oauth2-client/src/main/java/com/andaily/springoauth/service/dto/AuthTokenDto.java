...
public class AuthTokenDto implements Serializable {
    ...
    public AuthTokenDto setClientId(String clientId) {
    ...
    public AuthTokenDto setClientSecret(String clientSecret) {
    ...
    public AuthTokenDto setGrantType(String grantType) {
    ...
    public AuthTokenDto setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AuthTokenDto setRedirectUri(String redirectUri) {
    ...
    public AuthTokenDto setOauthTokenUri(String oauthTokenUri) {
