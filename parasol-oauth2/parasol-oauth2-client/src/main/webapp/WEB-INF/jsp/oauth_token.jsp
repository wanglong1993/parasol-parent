...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div ng-controller="CodeAccessTokenCtrl" class="col-md-10">
            ...
            <form action="oauth_token" method="post" class="form-horizontal">
                <input type="hidden" name="oauthTokenUri" value="${authTokenDto.oauthTokenUri}"/>

                <div class="form-group">
                    <label class="col-sm-2 control-label">oauthTokenUri</label>

                    <div class="col-sm-10">
                        <p class="form-control-static"><code>${authTokenDto.oauthTokenUri}</code>
                            &nbsp;<a href="${authTokenDto.oauthTokenUri}" target="_blank">测试连接</a>
                        </p>

                        <p class="help-block">
                            oauthTokenUri value from 'parasol-oauth2-client.properties'
                        </p>
                    </div>
                </div>
                ...
                <div ng-show="visible">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class="help-block">固定值 '${authTokenDto.grantType}'</p>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class="help-block">值是从 'parasol-oauth2-server' 返回的</p>
                        </div>
                    </div>
                    ...
                    <div class="well well-sm">
                        ...
                        <div class="text-primary">
                            {{oauthTokenUri}}?client_id={{clientId}}&client_secret={{clientSecret}}&grant_type={{grantType}}&redirect_uri={{redirectUri}}&code={{code}}
                        </div>
                    </div>
                </div>
                <br/>
...
<script>
    var CodeAccessTokenCtrl = ['$scope', function ($scope) {
        $scope.oauthTokenUri = '${authTokenDto.oauthTokenUri}';
        $scope.grantType = '${authTokenDto.grantType}';
        $scope.clientId = 'unity-client';

        $scope.clientSecret = 'unity';
        $scope.code = '${authTokenDto.code}';
