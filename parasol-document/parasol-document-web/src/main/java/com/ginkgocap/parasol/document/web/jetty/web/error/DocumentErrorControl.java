package com.ginkgocap.parasol.document.web.jetty.web.error;
...
@ControllerAdvice
public class DocumentErrorControl {
	public static Logger logger = Logger.getLogger(DocumentErrorControl.class);
