...
@JsonFilter("com.ginkgocap.parasol.favorite.model.FavoriteSource")
@Entity
@Table(name = "tb_favorite_source")
public class FavoriteSource implements Serializable {
	/**
	 * 
	 */
	...
	@Id
	@GeneratedValue(generator = "FavoriteSourcesId")
	@GenericGenerator(name = "FavoriteSourcesId", strategy = "com.ginkgocap.ywxt.framework.dal.dao.id.util.TimeIdGenerator", parameters = { @Parameter(name = "sequence", value = "FavoriteSourcesId") })
	@Column(name = "id")
	public long getId() {
		return id;
	}
	...
	public String toString() {
		return "FavoriteSources [id=" + id + ", favoriteId=" + favoriteId + ", appId=" + appId + ", userId=" + userId + ", sourceId=" + sourceId + ", sourceType=" + sourceType
