...
public class JTContact implements Serializable {
	...
	private com.ginkgocap.ywxt.person.model.Person people;
...
//	private List<PeopleCustomer> myPeopleCustomerList;
	...
	public com.ginkgocap.ywxt.person.model.Person getPeople() {
		return people;
	}

	public void setPeople(com.ginkgocap.ywxt.person.model.Person people) {
		this.people = people;
	}
/*
