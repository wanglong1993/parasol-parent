...
<div id="methodChange" >
	测试方法:<select id="changeUrlSelect" onchange="javascript:changeUrl();" onkeydown="if(event.keyCode == 8){this.options[0].text = '';}" onkeypress="writeSelect(this);">
		...
		<optgroup label="=============人脉begin================">
			...
			<option value="415" >/customer/meet/save.json 保存会面记录</option>
			<option value="430" >/customer/meet/update.json 修改会面记录</option>
			<option value="416" >/customer/meet/findList.json 查询会面情况列表</option>
			<option value="417" >/customer/meet/findOne.json 查询会面情况</option>
			<option value="418" >/customer/meet/deleteById.json 删除会面情况</option>
...
function changeUrl() {
	...
	arr_url[415] = '/customer/meet/save.json';//新增会面
	arr_url[430] = '/customer/meet/update.json';//修改会面记录
	arr_url[416] = 'customer/meet/findList.json';//查询会面情况列表
	arr_url[417] = '/customer/meet/findOne.json';//查询会面情况
	arr_url[418] = '/customer/meet/deleteById.json';//删除会面情况
	...
	loginInfo_arr[415]='{"meetDate":"meetDate","meetendDate":"meetendDate","title":"nihao","address":"beijingshihaidianqu","remark":"你会玩吗，坑死哥了，能不能像点样  miangtianzhunbeiquganshenm","creatortype":"2","tags":[{"tagId":"TagId","tagName":"TagName","type":"1"}],"associateList":[{"assoc_desc":"会议主持人","assoc_type_id":"1","associd":1,"assoc_title":"buzuowei"},{"assoc_desc":"会议主持人","assoc_type_id":"2","associd":1,"assoc_title":"buzuowei"},{"assoc_desc":"会议主持人","assoc_type_id":"3","associd":1,"assoc_title":"buzuowei"},{"assoc_desc":"会议主持人","assoc_type_id":"4","associd":1,"assoc_title":"buzuowei"}]}'
	loginInfo_arr[416]='{"creatortype":2,"currentPage":1,"pageSize":5}';
