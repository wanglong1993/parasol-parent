...
public class RequireImport extends TestBase implements Test {
	...
	public void testImport() throws CodeServiceException {
		...
		list.add(new DataStruct("职能->化工环保", false, "油田技术","化工技术","煤炭/天然气","法律法务","环保/水处理","高管","项目管理","工艺/研发","测绘勘探","采矿冶炼","机械机电","仪器仪表","生产/设备管理","车间技工","采购仓储物流","品质/质检","销售分销","维修客服","贸易进出口","市场策划","行政人事","翻译","网站/APP","其它"));
